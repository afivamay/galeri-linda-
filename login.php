...
<head>
   ...
   <style>
      ...
      body {
         background-color: #ffede7; /* Mengubah background body sesuai warna navbar */
      }
      .btn-danger {
         background-color: #c24244; /* Ubah warna tombol sesuai warna navbar */
         border-color: #c24244;
      }
      .btn-danger:hover {
         background-color: #a23233; /* Ubah warna tombol saat hover */
         border-color: #a23233;
      }
      .card-title, label {
         color: #7f4722; /* Ubah warna teks sesuai warna navbar */
      }
      .link-danger {
         color: #c24244; /* Ubah warna link sesuai warna navbar */
      }
      .link-danger:hover {
         color: #a23233; /* Warna link saat hover */
      }
   </style>
</head>
<body>
